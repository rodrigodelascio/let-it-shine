...
const MissionText = () => {
  return (
    <div className={styles["mission-section-wrapper"]}>
      ...
      <div className={styles["mission-text-container"]}>
        <div className={styles["mission-text"]}>
          ...
          <p>
            ...
            illuminating the potential within every space, enabling individuals
            and businesses to shine brighter. Join us on this mission of
            cleanliness and well-being. Contact Let It Shine today and let us
            help your space and your life truly shine.
          </p>
        </div>
      </div>
    </div>
